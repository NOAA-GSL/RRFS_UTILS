module module_read_prepbufr_metar
...
!
!$$$
  use module_kinds, only: r_single,r_kind,i_kind,r_double
  ...
  use module_reorg_metar_cloud, only: reorg_metar_cloud_regular
...
end module module_read_prepbufr_metar
