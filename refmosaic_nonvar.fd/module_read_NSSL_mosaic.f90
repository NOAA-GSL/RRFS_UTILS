...
!
  ...
  use module_netcdfsub, only: ifexist_file,open_mosaic,close_mosaic
  use module_netcdfsub, only: get_dim_att_mosaic,get_dim_att_mosaic8
  use module_netcdfsub, only: check_dim_att_mosaic,check_dim_att_mosaic8
  use module_netcdfsub, only: get_mosaic_sngl_mosaic
  use module_read_ncep_binary, only: read_ncep_binary_head,read_ncep_binary_value
  use module_read_nssl_binary, only: read_head_mosaic4,read_data_mosaic4
  use module_read_grib2, only: read_grib2_head,read_grib2_sngle
